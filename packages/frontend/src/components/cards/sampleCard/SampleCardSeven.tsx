  ...
  return (
    <div className="relative mb-0 overflow-hidden bg-white dark:bg-white/10 rounded-10">
      <h4 className="text-[18px] font-medium mb-[18px] text-dark dark:text-white/[.87] pt-[25px] px-[25px] flex items-center gap-[20px]">
        <img className="max-w-[50px]" src={`/hexadash-nextjs/${img}`} alt="" />
        <span className="text-dark dark:text-white/[.87]">{title}</span>
      </h4>
      <div className="px-[25px]">
        <p className="text-theme-gray dark:text-white/60 text-[15px]">{content}</p>
      </div>
      <div
        className={
          installed
      ...
      >
        ...
        <div className="flex card-short-actions">
          <div className="flex items-center content-installed content-action gap-[10px]">
            ...
            <div className="more">
              <DropDown customContent={moreContent}>
                <Link className="text-light-extra" href="#" onClick={(e: any) => e.preventDefault()}>
          ...
          <div className="flex items-center content-not-installed content-action gap-[10px]">
            <Buttons className="bg-primary hover:bg-primary-hbr border-solid border-1 border-primary text-white dark:text-white/[.87] text-[14px] font-semibold leading-[22px] inline-flex items-center justify-center rounded-[40px] px-[20px] h-[38px]">
              Install
            </Buttons>
            <div className="more">
              <DropDown
