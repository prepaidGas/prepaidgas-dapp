...
function SwRocket({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwShieldCheck({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwPenTool({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwNotification({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwUsers({ size, color, stroke, strokeWidth }:RootState) {
  return (
    <svg
      id="Group_1013"
...
function SwLayers({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwPicture({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwClock({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwSend({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwGraph({ size, color, stroke, strokeWidth }:RootState) {
  return (
...
function SwEllipse({ size, color, stroke, strokeWidth }:RootState) {
  return (
