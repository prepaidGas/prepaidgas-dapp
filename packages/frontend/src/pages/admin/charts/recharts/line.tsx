      ...
      <div className="min-h-[715px] lg:min-h-[580px] px-8 xl:px-[15px] pb-[30px] bg-transparent">
        <Row gutter={25}>
          <Col md={12} xs={24} className="mb-[25px]">
            <Cards className="ant-card-extra-none" title="SIMPLE LINE CHART" size="large" more={false}>
              <LineChart
          ...
          <Col md={12} xs={24} className="mb-[25px]">
            <Cards className="ant-card-extra-none" title="VERTICAL LINE CHART" size="large" more={false}>
              <LineChart
                layout="vertical"
                width={responsive - (5 * responsive) / 100}
                height={responsive / 2}
          ...
          <Col md={12} xs={24} className="mb-[25px]">
            <Cards className="ant-card-extra-none" title="CUSTOMIZED DOT LINE CHART" size="large" more={false}>
              <LineChart
                width={responsive - (5 * responsive) / 100}
                height={responsive / 2}
                data={data}
          ...
          <Col md={12} xs={24} className="mb-[25px]">
            <Cards className="ant-card-extra-none" title="LINE CHART WITH REFERENCE LINES" size="large" more={false}>
              <LineChart
                width={responsive - (5 * responsive) / 100}
                height={responsive / 2}
                data={data}
          ...
          <Col md={12} xs={24} className="mb-[25px]">
            <Cards className="ant-card-extra-none" title="DASHED LINE CHART" size="large" more={false}>
              <LineChart
                width={responsive - (5 * responsive) / 100}
                height={responsive / 2}
                data={data}
          ...
          <Col md={12} xs={24} className="mb-[25px]">
            <Cards className="ant-card-extra-none" title="LINE CHART WITH X-AXIS PADDING" size="large" more={false}>
              <LineChart
                width={responsive - (5 * responsive) / 100}
                height={responsive / 2}
                data={data}
          ...
          <Col md={12} xs={24} className="mb-[25px]">
            <Cards className="ant-card-extra-none" title="SYNCHRONIZED LINE CHART" size="large" more={false}>
              <div>
          ...
          <Col md={12} xs={24}>
            <Cards className="ant-card-extra-none" title="LINE CHART CONNECT NULLS" size="large" more={false}>
              <div>
                <LineChart
                  width={responsive - (5 * responsive) / 100}
                  height={responsive / 2}
