...
function SingleChat({ match, dashboard }: any) {
  ...
  return (
    <>
      <div
        className={`${pickerShow ? "block fixed start-0 top-0 w-full h-full bg-[#11121760] z-998" : "none"}`}
      ...
      <Cards
        ...
        title={
          <>
            <Heading as="h5" className="mb-1 text-lg font-medium text-dark dark:text-white/[.87]">
              {name}
            </Heading>
            <p className="mb-0 text-xs font-normal text-dark dark:text-white/[.87]">Active Now</p>
          </>
        }
        isbutton={[
                  ...
                  <Fragment key={id}>
                    ...
                    <li className="mb-[30px] px-[25px] sm:px-[15px] last:mb-0" key={id} style={{ overflow: "hidden" }}>
                      ...
                      >
                        ...
                        <div>
                          <Heading as="h5" className="text-sm font-semibold text-dark dark:text-white/[.87] mb-[10px]">
                            {mes.email !== me && name}
                          ...
                          {mes.email !== me ? (
                            <div className="flex items-center gap-[15px]">
                              ...
                              <div className="flex items-center gap-3">
                                <DropDown customContent={emojis} placement="bottom" className="[&>ul]:flex">
                                  <Link
                                    href="#"
                                ...
                                <DropDown customContent={settings} placement="bottom">
                                  <Link
                          ...
                          {mes.email === me && singleContent.length === index + 1 ? (
                            <div className="flex items-center justify-end mt-[10px] gap-[5px] text-end">
                              <span className="text-xs font-normal text-light dark:text-white/60">Seen 9:20 PM </span>
                              <img
          ...
          >
            <div className="flex items-center w-full gap-2">
              <span className="absolute ltr:left-[25px] rtl:right-[25px] flex items-center z-998 [&>aside.emoji-picker-react]:absolute ltr:[&>aside.emoji-picker-react]:right-[25px] rtl:[&>aside.emoji-picker-react]:left-[25px] [&>aside.emoji-picker-react]:top-auto [&>aside.emoji-picker-react]:bottom-[20%] [&>aside.emoji-picker-react]:flex [&>aside.emoji-picker-react]:items-center [&>aside.emoji-picker-react]:shadow-none [&>aside.emoji-picker-react]:z-998 [&>aside.emoji-picker-react>div]:w-full">
                ...
                <Link onClick={onPickerShow} href="#" className="text-light-extra dark:text-white/60">
