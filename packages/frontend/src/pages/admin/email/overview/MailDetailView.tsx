...
function Single() {
    ...
    return (
      <>
        <div className="flex gap-5 ssm:flex-col">
          <img className="w-[50px] h-[50px] rounded-full object-cover" src="/hexadash-nextjs/img/email/2.png" alt="" />
          <MailComposer replay defaultTag="Alice Freeman" onSend={() => replyMail("Your reply message")} />
        </div>
      </>
    )
  }
  ...
  function ForwardMessage() {
    return (
      <>
        <div className="flex gap-5 ssm:flex-col">
          <img className="w-[50px] h-[50px] rounded-full object-cover" src="/hexadash-nextjs/img/email/1.png" alt="" />
          <MailComposer replay defaultTag="Vincent Porter" onSend={() => replyMail("Your reply message")} />
        </div>
      </>
    )
  }
  ...
  const moreContent = [
    {
      ...
      label: (
        <div className="flex gap-x-[50px]">
          <span className="min-w-[40px] text-[#9299b8] dark:text-white/60">From:</span>{" "}
    ...
    },
    {
      ...
      label: (
        <div className="flex gap-x-[50px]">
          <span className="min-w-[40px] text-[#9299b8] dark:text-white/60">To:</span>
    ...
    },
    {
      ...
      label: (
        <div className="flex gap-x-[50px]">
          <span className="min-w-[40px] text-[#9299b8] dark:text-white/60">CC:</span>
          <span className="text-body dark:text-white/60">example@gamil.com</span>{" "}
        </div>
      ),
    },
    {
      ...
      label: (
        <div className="flex gap-x-[50px]">
          <span className="min-w-[40px] text-[#9299b8] dark:text-white/60">Date:</span>
          <span className="text-body dark:text-white/60">{moment(id).format("LLL")}</span>
        </div>
      ),
    },
  ]
    ...
    <div className="bg-white dark:bg-white/10 rounded-[10px]">
      <div className="flex items-center ssm:flex-col justify-between ssm:justify-center px-[25px] py-[13px] border-b border-regular dark:border-white/10">
        ...
        <div className="flex items-center py-3">
          <span className="text-light dark:text-white/60">1 - 50 of 235</span>
        </div>
      </div>
            ...
            <div className="px-[30px] ssm:px-0 border-b border-regular dark:border-white/10">
              ...
              <div className="flex items-center justify-between sm:flex-wrap gap-[15px]">
                <div className="flex items-center gap-5 mt-5">
                  ...
                  />
                  <div>
                    <Heading as="h4" className="mb-1 text-base font-medium text-dark dark:text-white/[.87]">
                      {userName}
                    </Heading>
                    <DropDown
                      placement="bottom"
                    ...
                    >
                      <Link href="#" className="flex items-center gap-[5px] text-light dark:text-white/60">
                        To {to}
                ...
                <div className="flex items-center xs:flex-wrap xs:gap-[10px]">
                  ...
                  <Link
                    className={`min-xs:px-[15px] ${stared ? "text-warning" : "text-light dark:text-white/60"}`}
                    onClick={() => onStaredChange(id)}
                    href="#"
                  >
                    <FontAwesome name="star-o" className="w-4 h-4" />
                  </Link>
                  <Link href="#" className="min-ssm:px-[15px] text-light dark:text-white/60">
              ...
              <div className="mt-[22px] min-sm:ltr:pl-[82px] min-sm:rtl:pr-[82px]">
                <span className="inline-block mb-10 sm:mb-5 text-body dark:text-white/60">Hello Adam,</span>
                <p className="min-sm:mb-[55px] sm:mb-[30px] text-body dark:text-white/60">{body}</p>

                <Heading as="h6" className="text-dark dark:text-white/[.87] text-[15px] font-normal leading-[30px]">
              ...
              <div className="flex flex-wrap mt-11 xs:mt-[15px] -mx-[5px] min-sm:ltr:pl-[82px] min-sm:rtl:pr-[82px]">
                <figure className="group relative p-2.5 mb-[30px] mx-[5px] border dark:border-white/10 rounded-[10px]">
                  <div className="relative before:absolute ltr:before:left-0 rtl:before:right-0 before:top-0 before:w-full before:h-0 before:bg-dark-transparent before:rounded-[10px] before:transition-all group-hover:before:h-full">
                    <img src="/hexadash-nextjs/img/email/2.png" alt="" />
                  </div>
                  ...
                  <figcaption className="mt-[10px]">
                    <Heading as="h4" className="mb-0 text-dark dark:text-white/[.87] text-[13px] font-semibold">
                      Attached.jpg
                    </Heading>
                    <p className="mb-0 text-xs text-body dark:text-white/60">256.5 KB</p>
                  </figcaption>
                </figure>

                <figure className="group relative p-2.5 mb-[30px] mx-[5px] border dark:border-white/10 rounded-[10px]">
                  <div className="relative before:absolute ltr:before:left-0 rtl:before:right-0 before:top-0 before:w-full before:h-0 before:bg-dark-transparent before:rounded-[10px] before:transition-all group-hover:before:h-full">
                    <img src="/hexadash-nextjs/img/email/1.png" alt="" />
                  </div>
                ...
                <figure className="group relative p-2.5 mb-[30px] mx-[5px] border dark:border-white/10 rounded-[10px]">
                  <div className="relative before:absolute ltr:before:left-0 rtl:before:right-0 before:top-0 before:w-full before:h-0 before:bg-dark-transparent before:rounded-[10px] before:transition-all group-hover:before:h-full">
                    <img src="/hexadash-nextjs/img/email/3.png" alt="" />
                  </div>
                  <div className="gap-x-[10px] absolute top-[80px] left-1/2 -translate-x-1/2 opacity-0 invisible transition-all group-hover:opacity-100 group-hover:visible">
                    <Link
                      className="relative inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#ffffff20]"
                ...
                <figure className="group relative p-2.5 mb-[30px] mx-[5px] border dark:border-white/10 rounded-[10px]">
                  <div className="relative before:absolute ltr:before:left-0 rtl:before:right-0 before:top-0 before:w-full before:h-0 before:bg-dark-transparent before:rounded-[10px] before:transition-all group-hover:before:h-full">
                    <img src="/hexadash-nextjs/img/email/4.png" alt="" />
                  </div>
                  <div className="gap-x-[10px] absolute top-[80px] left-1/2 -translate-x-1/2 opacity-0 invisible transition-all group-hover:opacity-100 group-hover:visible">
                    <Link
                      className="relative inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#ffffff20]"
        ...
        <Col xs={24}>
          <div className="flex items-start justify-between flex-wrap gap-5 mb-[50px] p-[30px] xs:pt-0 shadow-[0_15px_40px_rgba(116,116,116,0.06)]">
            <figure className="flex justify-between flex-wrap gap-[20px]">
              ...
              />
              <figcaption>
                <Heading as="h6" className="mb-3 font-medium text-dark dark:text-white/[.87]">
                  Reynante Labares
                </Heading>
            ...
            <div className="flex items-center flex-warp xs:gap-:[10px]">
              ...
              <Link
                className={`px-[15px] xs:px-[5px] ${stared ? "text-warning" : "text-light dark:text-white/60"}`}
                onClick={() => onStaredChange(id)}
                href="#"
              >
                <FontAwesome name="star-o" className="w-4 h-4" />
              </Link>
              <Link href="#" className="px-[15px] xs:px-[5px] text-light dark:text-white/60">
                <UilEllipsisV className="w-4 h-4" />
              </Link>
              <Link href="#" className="px-[15px] xs:px-[5px] text-light dark:text-white/60">
                <UilCornerUpLeft className="w-4 h-4" />
            ...
            <ul className="flex items-center flex-wrap xs:justify-center gap-2.5 mb-0">
              <li>
                <Link
                  ...
                  className={`inline-flex items-center h-10 px-[20px] gap-x-1 text-body dark:text-white/60 hover-text-primary border dark:border-white/10 rounded ${
                    state.replyLoading ? "pointer-events-none opacity-50" : ""
                  }`}
                >
              ...
              <li>
                <Link
                  ...
                  className={`inline-flex items-center h-10 px-[20px] gap-x-1 text-body dark:text-white/60 hover-text-primary border dark:border-white/10 rounded ${
                    state.forwardLoading ? "pointer-events-none opacity-50" : ""
                  }`}
                >
