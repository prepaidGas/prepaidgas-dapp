        ...
        <Form name="horizontal-icon-from" layout="horizontal">
          <Row align="middle">
            ...
            <Col lg={16} md={15} xs={24}>
              <Form.Item
                className="[&>div>div>div>div>span>span>svg]:w-[16px] [&>div>div>div>div>span>span]:mr-[10px] [&>div>div>div>div>span>span>svg]:h-[16px] [&>div>div>div>div>span>span>svg]:text-light-extra dark:[&>div>div>div>div>span>span>svg]:text-white/60"
                name="name"
                initialValue="Duran Clayton"
              >
                <Input prefix={<UilUser />} placeholder="Enter Name" className="h-12 p-3 rounded-6 border-normal dark:border-whiteDark hover:border-primary focus:border-primary dark:placeholder-white/60" />
              </Form.Item>
            </Col>
          </Row>
          <Row align="middle">
            ...
            <Col lg={16} md={15} xs={24}>
              <Form.Item
                className="[&>div>div>div>div>span>span>svg]:w-[16px] [&>div>div>div>div>span>.ant-input-prefix]:mr-[10px] [&>div>div>div>div>span>span>svg]:h-[16px] [&>div>div>div>div>span>span>svg]:text-light-extra dark:[&>div>div>div>div>span>span>svg]:text-white/60"
                name="email"
          ...
          <Row align="middle">
            <Col lg={8} md={9} xs={24}>
              <label className="dark:text-white/60" htmlFor="password">
                Password
              </label>
            </Col>
            <Col lg={16} md={15} xs={24}>
              ...
              >
                <Input.Password prefix={<UilLock />} placeholder="Enter Password" className="h-12 p-3 rounded-6 border-normal dark:border-whiteDark hover:border-primary focus:border-primary dark:placeholder-white/60" />
              </Form.Item>
            </Col>
          </Row>
          <Row>
...
export default HorizontalIconForm;
