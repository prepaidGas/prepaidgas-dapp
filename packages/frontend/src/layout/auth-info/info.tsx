      ...
      <div className="min-w-[280px] sm:min-w-full">
        <figure className="flex items-center text-sm rounded-[8px] bg-section dark:bg-white/10 py-[20px] px-[25px] mb-[12px]">
          <Image
            ...
            src={user?.picture ?? "/hexadash-nextjs/img/avatar/chat-auth.png"}
            alt=""
            width="50"
            height="50"
          />
      ...
      label: (
        ...
        >
          <Image
            ...
            src="/hexadash-nextjs/img/flag/en.png"
            alt=""
            width="20"
            height="20"
          />
    ...
    },
    {
      ...
      label: (
        ...
        >
          <Image
            className="w-3.5 h-3.5 ltr:mr-2 rtl:ml-2"
            src="/hexadash-nextjs/img/flag/esp.png"
            alt=""
            width="20"
            height="20"
          />
    ...
    },
    {
      ...
      label: (
        ...
        >
          <Image
            className="w-3.5 h-3.5 ltr:mr-2 rtl:ml-2"
            src="/hexadash-nextjs/img/flag/ar.png"
            alt=""
            width="20"
            height="20"
          />
      ...
      <div className="flex">
        <PopOver placement="bottomRight" content={userContent} action="click">
          <Link href="#" className="flex items-center overflow-x-auto text-light whitespace-nowrap">
            <Image
              src={user?.picture ?? "/hexadash-nextjs/img/avatar/matureman1.png"}
              alt="Avatar"
              width="32"
              height="32"
