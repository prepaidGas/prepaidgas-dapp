...
function MenuItems() {
  ...
  const items = [
    ...
    getItem(t("orders"), "orders", !topMenu && <UilFilePlusAlt />, [
      getItem(<Link href={`${path}/order/create`}>{t("Create Order")}</Link>, "createOrder", null, null),
      getItem(
        <Link href={`${path}/order/search`}>
          {t("search")} {t("orders")}
        </Link>,
        "searchOrders",
        null,
    ...
    //   getItem(<Link href={`${path}/ecommerce/products/grid`}>{t("products")}</Link>, "products", null, null),
    //   getItem(
    ...
    //     null,
    //   ),
    //   getItem(<Link href={`${path}/ecommerce/cart`}>{t("cart")}</Link>, "cart", null, null),
    //   getItem(<Link href={`${path}/ecommerce/orders`}>{t("orders")}</Link>, "orsers", null, null),
    //   getItem(<Link href={`${path}/ecommerce/sellers`}>{t("sellers")}</Link>, "sellers", null, null),
    //   getItem(<Link href={`${path}/ecommerce/invoice`}>{t("invoices")}</Link>, "Invoice", null, null),
    // ]),
    ...
    //     null,
    //   ),
    //   getItem(<Link href={`${path}/profile/myProfile/timeline`}>{t("timeline")}</Link>, "profileTimeline", null, null),
    //   getItem(<Link href={`${path}/profile/myProfile/activity`}>{t("activity")}</Link>, "profileActivity", null, null),
    // ]),
    ...
    //   getItem(<Link href={`${path}/support/tickets`}>{t("support")}</Link>, "support", null, null),
    //   getItem(
