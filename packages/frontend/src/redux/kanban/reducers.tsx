...
const { BOARD_READ_BEGIN, BOARD_READ_SUCCESS, BOARD_READ_ERR, TASK_READ_BEGIN, TASK_READ_SUCCESS, TASK_READ_ERR } =
  actions;

const kanbanBoardReducer = (state = initialState, action:any) => {
